...
import { PosTransaction } from "../../panel-personal/panel/components/pos-transaction";
...
const PanelInstitutional: React.FC = () => {
  ...
  return (
    <div className="w-full h-full grid grid-cols-3 gap-6 pt-8">
      <div className="w-full h-full grid grid-rows-[195px_1fr_auto] gap-6">
        <div className="w-full bg-actual-white p-10 rounded-2.5xl">
          <div className="flex items-center gap-4 pb-4 border-b border-base-content-10">
            <div className="w-9 h-9 flex justify-center items-center bg-dark-green/5 aspect-square rounded-full">
              <p className="text-sm text-dark-green">RS</p>
            </div>
            <div>
              <p className="text-sm text-base-content-40">İyi günler,</p>
              <h3 className="text-md text-base-content font-medium">
          ...
          <div className="pt-6 flex items-center gap-4">
            ...
            <div className="w-2 h-2 rounded-full bg-base-content/5"></div>
            <div>
        ...
        <div className="w-full bg-actual-white p-10 rounded-2.5xl">
          <div className="w-full flex justify-between pb-6 border-b border-base-content-10">
            <div>
              <h3 className="text-2xl text-base-content font-medium">
                ₺34.265,83
              </h3>
            ...
            <div className="flex flex-col gap-4 mt-6">
              ...
              <div className="w-full flex justify-between items-center">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-light-purple font-medium">
                    Charceback’ler
                  </p>
                </div>
                <p className="text-base-content font-medium">₺10.000,00</p>
      ...
      <div className="w-full col-span-2 grid grid-rows-[195px_1fr] gap-6">
        <div className="w-ful h-full grid grid-cols-4 bg-actual-white p-4 rounded-2.5xl">
          <Link
            onClick={() =>
              dispatch(
                rechangeToken("/dashboard/Institutional/linkPayment", navigate)
              )
            }
            to={"#"}
            className="flex flex-col justify-center items-center gap-2 border-r"
          >
          ...
          <Link
            onClick={() =>
              dispatch(
                rechangeToken(
                  "/dashboard/Institutional/webManagement",
                  navigate
                )
              )
            }
          ...
          <Link
            onClick={() =>
              dispatch(
                rechangeToken(
                  "/dashboard/Institutional/transactionReport",
                  navigate
                )
              )
            }
          ...
          <Link
            onClick={() =>
              dispatch(
                rechangeToken(
                  "/dashboard/Institutional/userAuthorization",
                  navigate
                )
              )
            }
          ...
          <div className="w-full grid grid-rows-2 gap-6">
            <div className="bg-actual-white flex flex-col pt-6   rounded-2.5xl">
              <div className="mb-4 px-6">
                <h3 className="text-xl text-base-content font-medium">
                  Gelirler
                </h3>
              </div>
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Bar
                    dataKey="pv"
                    fill="#38BDF8"
                    activeBar={<Rectangle fill="#38BDF8" stroke="#38BDF8" />}
                  />
                  <Bar
                    dataKey="uv"
                    fill="#6366F1"
                    activeBar={<Rectangle fill="#6366F1" stroke="#6366F1" />}
                  />
                </BarChart>
              </ResponsiveContainer>
            </div>
            <div className="bg-actual-white flex flex-col p-6 rounded-2.5xl">
              ...
              <div className="flex items-start gap-1">
                <h3 className="text-3xl text-[#1E293B] font-inter font-bold">
                  $9.962
                </h3>
                <p className="text-sm text-actual-white bg-[#10B981] font-inter font-medium px-1 rounded-2.5xl">
                  +29%
                </p>
              </div>
          ...
          <div className="w-full h-full bg-actual-white rounded-2.5xl p-6">
            ...
            <div className="mt-6">
              ...
              <PosTransaction
                ...
                subTitle="Salı, 10:57"
                price="₺1.000,00"
                image={userTransaction}
              />
              <PosTransaction
                title="Bakiye Yükleme"
                subTitle="Salı, 10:57"
                price="₺3.890,41"
                image={plusTransaction}
              />
              <PosTransaction
                title="Bakiye Yükleme"
                subTitle="Salı, 10:57"
